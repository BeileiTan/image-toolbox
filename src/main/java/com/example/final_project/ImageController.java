...
public class ImageController implements Initializable {
    ...
    /* This is used to upload image with extension *jpg or *png */
    ...
    /* This is used to download image with extension *jpg or *png */
    ...
    /* This is used to clear the image view and reset to the default*/
    ...
    /* This is used to close the window and exit program */
    public void onClick_close(ActionEvent e) {
        System.exit(0);
    }

    /* This is used to rotate the image clockwise */
    public void onClick_rotateX(ActionEvent e) {
        img.setRotationAxis(Rotate.Z_AXIS);
        img.setRotate(img.getRotate() + 90);
    }

    /* This is used to rotate the image counter-clockwise */
    public void onClick_rotateY(ActionEvent e) {
        img.setRotationAxis(Rotate.Z_AXIS);
        img.setRotate(img.getRotate() - 90);
    }

    /* This is used to rotate the image along Y-axis */
    ...
    /* This is used to rotate the image along X-axis */
